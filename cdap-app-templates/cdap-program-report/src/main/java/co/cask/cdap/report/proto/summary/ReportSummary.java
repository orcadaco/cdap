...
public class ReportSummary {
  ...
  /**
   * @return start time in seconds from {@link report.proto.ReportGenerationRequest#start}
   */
  ...
  /**
   * @return end time in seconds from {@link report.proto.ReportGenerationRequest#end}
